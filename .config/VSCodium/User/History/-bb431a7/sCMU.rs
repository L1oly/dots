...
fn help(){
    ...
    println!("  add       - add a new match");
    println!("  stats     - show overall stats");
    println!("  history   - show all matches");
    println!("  clear     - clear console");
    println!("  del_stats - clears all previous match stats");
    println!("  quit      - exit");
}
...
fn main() {
    ...
    match input.trim() {
        ...
        "del_stats" => { 
                    t.matches.clear(); 
                    save(&t.matches);   
                    println!("matched data cleared");
                }
        "quit" =>    { break; }
        _ =>         { println!("unknown command(? for help)"); }
    }
    }
}
