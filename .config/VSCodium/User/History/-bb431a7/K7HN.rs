...
fn stats(matches: &Vec<Match>){
    ...
    println!("avg kills: {:.2}", total_deaths as f64 / total);
    println!("avg kills: {:.2}", total_kd as f64 / total);
    println!("avg kills: {:.2}", total_assists as f64 / total);
    println!("avg kills: {:.2}", total_headshots as f64 / total);
    println!("avg kills: {:.2}", total_hs_persent as f64 / total);
    println!("avg kills: {:.2}", total_kills as f64 / total);
}
